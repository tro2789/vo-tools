...
export const metadata: Metadata = {
  ...
  description:
    'Analyze voiceover scripts for word count, estimated read time at different speeds, and calculate pricing. Free tool for voice actors.',
  alternates: { canonical: '/script-analysis' },
};

export default function ScriptAnalysisPage() {
  return <ScriptCalculator />;
}
