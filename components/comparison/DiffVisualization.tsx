  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-[#072030] rounded-2xl shadow-xs border border-gray-200 dark:border-gray-700/50 overflow-hidden">
          <div className="px-5 py-3 border-b border-gray-100 dark:border-gray-700/50 bg-gray-50/50 dark:bg-[#072030]/50">
      ...
      <div className="bg-white dark:bg-[#072030] rounded-xl shadow-xs border border-gray-200 dark:border-gray-700/50 p-5">
        ...
        <div className="flex flex-wrap gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-gray-500">New text in revised</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="bg-red-200 dark:bg-red-900/40 text-red-900 dark:text-red-200 line-through px-2 py-1 rounded-sm text-sm">
              Removed
            </span>
            <span className="text-xs text-gray-500">Deleted from original</span>
          </div>
        </div>
      </div>
    </>
